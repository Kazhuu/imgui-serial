...
ImGuiBackend::ImGuiBackend(std::string app_name) : _app_name(app_name) {
}
...
void ImGuiBackend::init_imgui() {
    ...
    _window = SDL_CreateWindow("SPC Player", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 1280, 720, window_flags);
...
void ImGuiBackend::start_frame() {
    ...
    ImGui::Begin(_app_name, NULL, flags);
}
